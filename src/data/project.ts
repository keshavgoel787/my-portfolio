...
export const projects: Project[] = [
  {
    title: "ForgetMeNot",
    thumbnail:"/media/forgetmenot-thumbnail.png", 
    description:
      "Won HackRU 2025 for a platform to help slow the onset of Dementia through active recall made possible with Vector Databases, Facial Recognition, Narrated Events, and GenAI",
    why: "We all have family with Dementia and learned that the progress of the disease can be slowed by remembering past events. Biggest challenge was setting up a fast facial recognition pipeline that seamlessly integrated with Snowflake Cortex",
    tech: ["PyTorch", "Snowflake", "Gemini", "GCP","ElevenLabs", "REST APIs"],
    link: "https://github.com/keshavgoel787/ForgetMeNot",
  },
  {
    title: "NUPathfinder",
    description:
    ...
    link: "https://github.com/keshavgoel787/NUPathfinder",
  },
  {
    title: "BreatheEasy",
    description:
      "Won 1st place out of 400+ teams at CSBase Climate Hacks 2024 for an eco-friendly route planning app using Google Maps + AQI data APIs. Scaled backend services to handle 10K+ API requests/day with Shelf and Docker, providing real-time air quality routing for urban commuters.",
    ...
    link: "https://github.com/Joeweh/BreatheEasy",
  },
  {
    title: "Textmate",
    description:
    ...
    link: "https://github.com/keshavgoel787/Textmate",
  },
  {
    title: "Bububble",
    description:
    ...
    link: "https://github.com/keshavgoel787/Bububble",
  },
];
